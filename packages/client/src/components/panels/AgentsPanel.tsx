              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className="mt-0.5 shrink-0 text-[var(--muted-foreground)] transition-colors hover:text-[var(--primary)] disabled:cursor-wait disabled:opacity-50"
                  >
                    {enabled ? (
                      <ToggleRight size="0.875rem" className="text-emerald-400" />
                    ) : (
